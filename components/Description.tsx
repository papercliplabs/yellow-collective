            ...
            <div className="w-full flex flex-col justify-center items-center gap-0">
                ...
                <div className="bg-white w-full flex justify-center pt-8">
                    <div className="max-w-[720px] px-6 w-full flex flex-col gap-4 [&>p]:text-secondary">
                        <h2>What is The Yellow Collective and What Are Collective Nouns?</h2>
                        <p>
                            ...
                            ecosystems. One Collective Noun will be auctioned off here every day, forever. Auction
                            proceeds will be used to host art contests and pay commissions to creatives in our
                            communities, in collaboration with{" "}
                            <ExternalLink href="https://tns.wtf">The Noun Square Onchain Media Collective</ExternalLink>
                            .
                        </p>
                        ...
                        <p>
                            Oh and, why “Yellow”? Well, because yellow is bright and optimistic, it{"'"}s one of the
                            original brand colors of Nouns DAO, as well as the main logo color for The Noun Square, and
                            the name is also an homage to Purple DAO and all the good they have done for the Farcaster
                            ecosystem. And finally, it{"'"}s just a great meme too! 🟡
                        </p>
                        <h2 className="pt-4">Nouns Made By the Community, For the Community</h2>
                        <p>
                            Collective Nouns are made in the image of the original{" "}
                            <ExternalLink href="https://nouns.wtf">Nouns DAO</ExternalLink>, except that all of the Head
                        ...
                        <p>
                            They all sport the same distinctive Yellow Collective Noggles (so that we can always tell
                            they{"'"}re family!) And in lieu of the “warm” and “cool” backgrounds of classic Nouns,
