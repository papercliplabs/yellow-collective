export const auctionAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "_rewardsManager", type: "address" },
      { internalType: "address", name: "_weth", type: "address" },
      { internalType: "uint16", name: "_builderRewardsBPS", type: "uint16" },
      { internalType: "uint16", name: "_referralRewardsBPS", type: "uint16" },
    ],
  ...
  { inputs: [], name: "INVALID_REWARDS_BPS", type: "error" },
  { inputs: [], name: "INVALID_REWARDS_RECIPIENT", type: "error" },
  { inputs: [], name: "INVALID_REWARD_TOTAL", type: "error" },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint16", name: "percentBps", type: "uint16" },
        ],
        indexed: false,
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint16", name: "_founderRewardBps", type: "uint16" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
